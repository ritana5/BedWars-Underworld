package net.ritana5.underworld.menu.bedwars1058;
            ...
            if (JavaPlugin.getPlugin(Underworld.class).getSouls().get((Player) e.getWhoClicked()) >= finalPrice1) {
                ...
                e.getWhoClicked().sendMessage(ChatColor.translateAlternateColorCodes('&',
                        Language.getMsg((Player) e.getWhoClicked(), "shop-new-purchase")
                                ...
                                .replace("{item}", "&6" + Language.getMsg(player, "addons.underworld.diamond.item-nameChat"))));
            } else {
                ...
                e.getWhoClicked().sendMessage(ChatColor.translateAlternateColorCodes('&',
                        Language.getMsg((Player) e.getWhoClicked(), "shop-insuff-money")
                                .replace("{prefix}", Language.getMsg((Player) e.getWhoClicked(), "prefix"))
                                .replace("{amount}", String.valueOf(finalPrice1 - JavaPlugin.getPlugin(Underworld.class).getSouls().get((Player) e.getWhoClicked())))
                                .replace("{currency}", API.convertCurrencyToString(player, souls))));
            }
        });
        ...
        super.setItem(slotForItem2, itemStack2, (e) -> {
            if (JavaPlugin.getPlugin(Underworld.class).getSouls().get((Player) e.getWhoClicked()) >= finalPrice2) {
                ...
                e.getWhoClicked().sendMessage(ChatColor.translateAlternateColorCodes('&',
                        Language.getMsg((Player) e.getWhoClicked(), "shop-new-purchase")
                                .replace("{prefix}", Language.getMsg((Player) e.getWhoClicked(), "prefix"))
                                .replace("{item}", "&6" + Language.getMsg(player, "addons.underworld.emerald.item-nameChat"))));
            } else {
                // send not enough resources message .-.
                ((Player) e.getWhoClicked()).playSound(e.getWhoClicked().getLocation(), GSound.ENTITY_VILLAGER_NO.parseSound(), 1.0f, 1.0f);
                InventoryGui menu = new UnderworldMenu(player);
                ...
                e.getWhoClicked().sendMessage(ChatColor.translateAlternateColorCodes('&',
                        Language.getMsg((Player) e.getWhoClicked(), "shop-insuff-money")
                                .replace("{prefix}", Language.getMsg((Player) e.getWhoClicked(), "prefix"))
                                .replace("{amount}", String.valueOf(finalPrice2 - JavaPlugin.getPlugin(Underworld.class).getSouls().get((Player) e.getWhoClicked())))
                                .replace("{currency}", API.convertCurrencyToString(player, souls))));
            }
        });
        ...
        super.setItem(slotForItem3, itemStack3, (e) -> {
            if (JavaPlugin.getPlugin(Underworld.class).getSouls().get((Player) e.getWhoClicked()) >= finalPrice3) {
                ...
                e.getWhoClicked().sendMessage(ChatColor.translateAlternateColorCodes('&',
                        Language.getMsg((Player) e.getWhoClicked(), "shop-new-purchase")
                                .replace("{prefix}", Language.getMsg((Player) e.getWhoClicked(), "prefix"))
                                .replace("{item}", "&6" + Language.getMsg(player, "addons.underworld.recall.item-nameChat"))));
            } else {
                // send not enough resources message .-.
                ((Player) e.getWhoClicked()).playSound(e.getWhoClicked().getLocation(), GSound.ENTITY_VILLAGER_NO.parseSound(), 1.0f, 1.0f);
                InventoryGui menu = new UnderworldMenu(player);
                ...
                e.getWhoClicked().sendMessage(ChatColor.translateAlternateColorCodes('&',
                        Language.getMsg((Player) e.getWhoClicked(), "shop-insuff-money")
                                .replace("{prefix}", Language.getMsg((Player) e.getWhoClicked(), "prefix"))
                                .replace("{amount}", String.valueOf(finalPrice3 - JavaPlugin.getPlugin(Underworld.class).getSouls().get((Player) e.getWhoClicked())))
                                .replace("{currency}", API.convertCurrencyToString(player, souls))));
            }
        });
        ...
        super.setItem(slotForItem4, itemStack4, (e) -> {
            if (JavaPlugin.getPlugin(Underworld.class).getSouls().get((Player) e.getWhoClicked()) >= finalPrice4) {
                ...
                e.getWhoClicked().sendMessage(ChatColor.translateAlternateColorCodes('&',
                        Language.getMsg((Player) e.getWhoClicked(), "shop-new-purchase")
                                .replace("{prefix}", Language.getMsg((Player) e.getWhoClicked(), "prefix"))
                                .replace("{item}", "&6" + Language.getMsg(player, "addons.underworld.stick.item-nameChat"))));
            } else {
                // send not enough resources message .-.
                ((Player) e.getWhoClicked()).playSound(e.getWhoClicked().getLocation(), GSound.ENTITY_VILLAGER_NO.parseSound(), 1.0f, 1.0f);
                InventoryGui menu = new UnderworldMenu(player);
                ...
                e.getWhoClicked().sendMessage(ChatColor.translateAlternateColorCodes('&',
                        Language.getMsg((Player) e.getWhoClicked(), "shop-insuff-money")
                                .replace("{prefix}", Language.getMsg((Player) e.getWhoClicked(), "prefix"))
                                .replace("{amount}", String.valueOf(finalPrice4 - JavaPlugin.getPlugin(Underworld.class).getSouls().get((Player) e.getWhoClicked())))
                                .replace("{currency}", API.convertCurrencyToString(player, souls))));
            }
        });
        ...
        super.setItem(slotForItem5, itemStack5, (e) -> {
            if (JavaPlugin.getPlugin(Underworld.class).getSouls().get((Player) e.getWhoClicked()) >= finalPrice5) {
                ...
                e.getWhoClicked().sendMessage(ChatColor.translateAlternateColorCodes('&',
                        Language.getMsg((Player) e.getWhoClicked(), "shop-new-purchase")
                                .replace("{prefix}", Language.getMsg((Player) e.getWhoClicked(), "prefix"))
                                .replace("{item}", "&6" + Language.getMsg(player, "addons.underworld.sword.item-nameChat"))));
            } else {
                // send not enough resources message .-.
                ((Player) e.getWhoClicked()).playSound(e.getWhoClicked().getLocation(), GSound.ENTITY_VILLAGER_NO.parseSound(), 1.0f, 1.0f);
                InventoryGui menu = new UnderworldMenu(player);
                ...
                e.getWhoClicked().sendMessage(ChatColor.translateAlternateColorCodes('&',
                        Language.getMsg((Player) e.getWhoClicked(), "shop-insuff-money")
                                .replace("{prefix}", Language.getMsg((Player) e.getWhoClicked(), "prefix"))
                                .replace("{amount}", String.valueOf(finalPrice5 - JavaPlugin.getPlugin(Underworld.class).getSouls().get((Player) e.getWhoClicked())))
                                .replace("{currency}", API.convertCurrencyToString(player, souls))));
            }
        });
        ...
        super.setItem(slotForItem6, itemStack6, (e) -> {
            if (JavaPlugin.getPlugin(Underworld.class).getSouls().get((Player) e.getWhoClicked()) >= finalPrice6) {
                ...
                e.getWhoClicked().sendMessage(ChatColor.translateAlternateColorCodes('&',
                        Language.getMsg((Player) e.getWhoClicked(), "shop-new-purchase")
                                .replace("{prefix}", Language.getMsg((Player) e.getWhoClicked(), "prefix"))
                                .replace("{item}", "&6" + Language.getMsg(player, "addons.underworld.ice.item-nameChat"))));
            } else {
                // send not enough resources message .-.
                ((Player) e.getWhoClicked()).playSound(e.getWhoClicked().getLocation(), GSound.ENTITY_VILLAGER_NO.parseSound(), 1.0f, 1.0f);
                InventoryGui menu = new UnderworldMenu(player);
                ...
                e.getWhoClicked().sendMessage(ChatColor.translateAlternateColorCodes('&',
                        Language.getMsg((Player) e.getWhoClicked(), "shop-insuff-money")
                                .replace("{prefix}", Language.getMsg((Player) e.getWhoClicked(), "prefix"))
                                .replace("{amount}", String.valueOf(finalPrice6 - JavaPlugin.getPlugin(Underworld.class).getSouls().get((Player) e.getWhoClicked())))
                                .replace("{currency}", API.convertCurrencyToString(player, souls))));
            }
        });
        ...
        super.setItem(slotForItem7, itemStack7, (e) -> {
            if (JavaPlugin.getPlugin(Underworld.class).getSouls().get((Player) e.getWhoClicked()) >= finalPrice7) {
                ...
                e.getWhoClicked().sendMessage(ChatColor.translateAlternateColorCodes('&',
                        Language.getMsg((Player) e.getWhoClicked(), "shop-new-purchase")
                                .replace("{prefix}", Language.getMsg((Player) e.getWhoClicked(), "prefix"))
                                .replace("{item}", "&6" + Language.getMsg(player, "addons.underworld.ender.item-nameChat"))));
            } else {
                // send not enough resources message .-.
                ((Player) e.getWhoClicked()).playSound(e.getWhoClicked().getLocation(), GSound.ENTITY_VILLAGER_NO.parseSound(), 1.0f, 1.0f);
                InventoryGui menu = new UnderworldMenu(player);
                ...
                e.getWhoClicked().sendMessage(ChatColor.translateAlternateColorCodes('&',
                        Language.getMsg((Player) e.getWhoClicked(), "shop-insuff-money")
                                .replace("{prefix}", Language.getMsg((Player) e.getWhoClicked(), "prefix"))
                                .replace("{amount}", String.valueOf(finalPrice7 - JavaPlugin.getPlugin(Underworld.class).getSouls().get((Player) e.getWhoClicked())))
                                .replace("{currency}", API.convertCurrencyToString(player, souls))));
            }
        });
